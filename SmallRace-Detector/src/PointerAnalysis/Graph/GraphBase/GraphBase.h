...
struct GraphTraits<const pta::GraphBase<NodeType, EdgeType>> {
  using GraphType = typename pta::GraphBase<NodeType, EdgeType>;
  // Elements to provide:
...
template <typename NodeType, typename EdgeType>
struct GraphTraits<pta::GraphBase<NodeType, EdgeType>> {
  using GraphType = typename pta::GraphBase<NodeType, EdgeType>;
  // Elements to provide:
  // typedef NodeRef           - Type of Node token in the callgraph, which
  // should
...
// inverse iterate the
template <typename NodeType, typename EdgeType>
struct GraphTraits<Inverse<const pta::GraphBase<NodeType, EdgeType>>> {
  using GraphType = const typename pta::GraphBase<NodeType, EdgeType>;
  // Elements to provide:
  // typedef NodeRef           - Type of Node token in the callgraph, which
  // should
  //                             be cheap to copy.
...
// inverse iterate the
template <typename NodeType, typename EdgeType>
struct GraphTraits<Inverse<pta::GraphBase<NodeType, EdgeType>>> {
  using GraphType = typename pta::GraphBase<NodeType, EdgeType>;
  // Elements to provide:
  // typedef NodeRef           - Type of Node token in the callgraph, which
  // should
