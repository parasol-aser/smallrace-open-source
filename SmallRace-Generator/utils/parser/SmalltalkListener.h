...
public:
  ...
  virtual void enterTemps1(SmalltalkParser::Temps1Context *ctx) = 0;
  virtual void exitTemps1(SmalltalkParser::Temps1Context *ctx) = 0;

  virtual void enterTemps2(SmalltalkParser::Temps2Context *ctx) = 0;
  virtual void exitTemps2(SmalltalkParser::Temps2Context *ctx) = 0;
