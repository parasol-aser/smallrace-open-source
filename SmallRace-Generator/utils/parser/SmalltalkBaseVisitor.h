...
public:
  ...
  virtual antlrcpp::Any visitTemps1(SmalltalkParser::Temps1Context *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitTemps2(SmalltalkParser::Temps2Context *ctx) override {
    return visitChildren(ctx);
  }
